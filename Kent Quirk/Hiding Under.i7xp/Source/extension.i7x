Version 1/210316 of Hiding Under by Kent Quirk begins here.

"Allows things to be hidden under other things, using a many-to-one underconcealment relation. Can be used either standalone (with basic functionality) or in conjunction with Underside (to add fuller functionality to both extensions). This Version of Hiding Under avoids using phrases deprecated in Version 6M68 of Inform."

"Based on Version 4 of Hiding Under by Eric Eve."
